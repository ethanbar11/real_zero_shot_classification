...
def parse_args(args):
    ...
    parser.add_argument(
        "--dataset-type",
        choices=["webdataset", "csv", "synthetic", "auto", "csv_unique", "csv_unique_with_full_classes",
                 "csv_dataset_negatives"],
        default="auto",
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to class-attribute config file, for conducting zero shot evaluation.",
    )
    parser.add_argument(
        "--more-than-one-val-data",
        action='store_true',
        help="If you want to do the validation on more than one file, if so, --val arg should direct to a list of files",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to descriptions file with negatives, only relevant for dataset \'csv_dataset_negatives\'",
    )
