...
from openclip_modified.loss_open_clip import ClipLoss, DistillClipLoss, CoCaLoss, SigLipLoss, NegativeClipLoss
...
from open_clip.transform import image_transform_v2, AugmentationCfg, PreprocessCfg, \
...
def create_loss(args):
    ...
    elif args.negatives_file_path:
        return NegativeClipLoss(
            local_loss=args.local_loss,
            gather_with_grad=args.gather_with_grad,
            cache_labels=True,
            rank=args.rank,
