...
class OxfordIIITPetDataset(torch.utils.data.Dataset):
    ...
    def __init__(self,
        ...
        self.classes = [fix_classname_special_chars(c) for c in self.classes]
    ...
    def _fit_dataset_to_category_list(self, list_of_categories: List[str] = ["Laysan Albatross", "Sooty Albatross", "Rhinoceros Auklet", "Least Auklet"]):
        ...
        list_of_cat_idx = [self.class_to_idx[cat] for cat in list_of_categories]
    ...
    def __getitem__(self, index):
        ...
        return sample, target, image_file, self.idx_to_class[target]
