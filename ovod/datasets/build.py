...
from .CUBDatasetLinearProbing import CubDatasetLinearProbing
from .CUBDatasetPartsAndAttributes import CubDatasetPartsAndAttributes
from .Cars196Dataset import Cars196Dataset
from .Cars196Dataset import _transform as Cars196_transform
from .Dogs120Dataset import Dogs120Dataset
from .Dogs120Dataset import _transform as Dogs120_transform
...
#from .Food101Dataset import _transform as Food101_transform
...
def build_dataset(dataset_name: str, cfg: CfgNode, split: str, **args):
    ...
    elif 'Cars196' == dataset_name:
        loader_func = [Cars196Dataset]
        input_transform = [Cars196_transform(cfg.TRAIN.INPUT_SIZE)]

    elif 'Dogs120' == dataset_name:
        loader_func = [Dogs120Dataset]
        input_transform = [Dogs120_transform(cfg.TRAIN.INPUT_SIZE)]

    elif "food101" == dataset_name.lower():
        loader_func = [Food101Dataset]
        input_transform = [Food101Dataset._transform(cfg.TRAIN.INPUT_SIZE)]
    ...
    elif 'CubDatasetPartsAndAttributes' == dataset_name:
        loader_func = [CubDatasetPartsAndAttributes]
        input_transform = [CUB_transform(cfg.TRAIN.INPUT_SIZE)]
    # elif 'CubDatasetLinearProbing':
    #     loader_func = [CubDatasetLinearProbing]
